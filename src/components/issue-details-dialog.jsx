...
import { deleteIssue, updateIssue } from "../services/issueService";
...
export default function IssueDetailsDialog({
  ...
  const reporterClerkId = issue?.reporter?.clerkUserId;
  const canChange =
    (user?.id && reporterClerkId && user.id === reporterClerkId) ||
    membership?.role === "org:admin";

  const handleGoToProject = () => {
    navigate(`/project/${issue.projectId}?sprint=${issue.sprintId}`);
  };
